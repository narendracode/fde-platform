...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql+asyncpg://fde:fdepass@localhost:5432/fde_agent"
    database_url_sync: str = "postgresql://fde:fdepass@localhost:5432/fde_agent"
    ...
    langchain_project: str = "fde-agent-poc"
    ...
    otel_service_name: str = "fde-agent"
