...
from fde_agent.db.models import Agent, AgentAction, AgentRefineMessage, AgentRefineSession
from fde_agent.db.session import AsyncSessionLocal, get_session
...
async def refine_message(
    ...
    async def event_generator() -> AsyncGenerator[str, None]:
        from fde_agent.agent import build_agent
        from fde_agent.agent.react_agent import _langsmith_url
