...
celery_app.conf.update(
    ...
    task_annotations={"fde_agent.queue.tasks.run_agent_task": {"rate_limit": "10/m"}},
    # Concurrency control per queue
    task_routes={
        "fde_agent.queue.tasks.run_agent_task": {"queue": "agent_runs"},
    },
...
def _setup_otel_in_worker(**_kwargs):
    ...
    """
    from fde_agent.telemetry import instrument_celery, instrument_redis, setup_otel
    setup_otel()
    instrument_celery()
    instrument_redis()
